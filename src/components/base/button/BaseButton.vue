...
<template>
  <button
    ...
    class="inline-flex items-center justify-center gap-2 font-bold transition-all duration-300 ease-in-out rounded outline-0 ring-0 focus-visible:ring-0 font-playfair"
